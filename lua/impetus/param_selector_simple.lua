...
function M.show_param_selector()
  ...
  print("keyword: " .. context.keyword)
  print("param name: " .. context.param_name)
  print("param index: " .. context.param_idx)

  -- Parse current line to show parameters
  local params_in_row = split_csv(current_line)
  print("param count: " .. #params_in_row)
