...
-- Re-apply highlights after colorscheme changes so plugins/colorschemes cannot
-- permanently override our groups.
vim.api.nvim_create_autocmd("ColorScheme", {
  group = vim.api.nvim_create_augroup("ImpetusHighlight", { clear = true }),
  callback = function()
    M.apply()
  end,
})
...
local palette = {
  ...
  info_divider = "#4f5f73",
  cheat_title = "#7ee8ff",
  cheat_section = "#ffd166",
  cheat_command = "#7ee8ff",
  cheat_desc = "#d7dde6",
}
...
function M.apply()
  ...
  -- Neutral base color for control directives (overlay provides vivid per-pair colors)
  hi("impetusControlStart", { fg = "#8899aa", bold = true })
  hi("impetusControlMid", { fg = "#8899aa", bold = true, italic = true })
  hi("impetusControlEnd", { fg = "#8899aa", bold = true })
  ...
  -- Scope-pair family colors (2 shades per family, cycling)
  hi("impetusIfPair1", { fg = "#00d4ff", bold = true })
  hi("impetusIfPair2", { fg = "#0077be", bold = true })
  hi("impetusRepeatPair1", { fg = "#00ff88", bold = true })
  hi("impetusRepeatPair2", { fg = "#00aa55", bold = true })
  hi("impetusConvertPair1", { fg = "#ffdd00", bold = true })
  hi("impetusConvertPair2", { fg = "#cc9900", bold = true })
  hi("impetusScopePair1", { fg = "#ff3366", bold = true })
  hi("impetusScopePair2", { fg = "#cc0033", bold = true })
  ...
  hi("impetusCheatTitle", { fg = palette.cheat_title, bold = true })
  hi("impetusCheatSection", { fg = palette.cheat_section, bold = true })
  hi("impetusCheatCommand", { fg = palette.cheat_command, bold = true })
  hi("impetusCheatDesc", { fg = palette.cheat_desc })
  ...
  -- Lint diagnostic colors: red for ERROR, yellow for WARNING, cyan for HINT/SUSPICION
  hi("DiagnosticError", { fg = "#ff4444" })
  hi("DiagnosticWarn", { fg = "#ffd166" })
  hi("DiagnosticHint", { fg = "#00d7ff" })
end
